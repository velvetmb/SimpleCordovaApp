...
*/			
			var camera, scene, renderer, effect=null, controls, deviceType=null, toExit=false, toNotExit=false,
			...
			var stereoDiv, leftDiv, rightDiv, leftInterior, rightInterior, inWorldDiv, descriptionDuration = 5, divText = "";
			...
			function createPano(right, left, up, down, back, front, toRenderFirst, audioFile, type, description, latitude, longitude, name)
			{
				var pano = [
					{
						url: left,
